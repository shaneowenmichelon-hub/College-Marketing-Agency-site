    ...
    blocks: [
      {
        ...
        image: "/images/thaw-out/thaw-out-02.jpg",
        imageAlt: "College festival crowd and stage activation",
      ...
      },
      {
        ...
        imageAlt: "Product placement table with branded drinks at a college event",
      ...
      items: [
        {
          ...
          highlights: [
            ...
            "Strong fit for beverage, travel, apparel, fintech, and lifestyle activations",
            "Brand visibility can be packaged across any or all JusCollege trips",
          ],
        },
        {
          ...
          highlights: [
            ...
            "Resort-market environment for sampling, hospitality, and content capture",
            "Brand visibility can be packaged across any or all JusCollege trips",
          ],
        },
        {
          ...
          highlights: [
            ...
            "Activation-friendly resort and party environment",
            "Brand visibility can be packaged across any or all JusCollege trips",
          ],
        },
        {
          ...
          highlights: [
            ...
            "Strong fit for travel, beverage, wellness, and lifestyle sponsors",
            "Brand visibility can be packaged across any or all JusCollege trips",
          ],
        },
        {
          ...
          highlights: [
            ...
            "Content-friendly student travel environment",
            "Brand visibility can be packaged across any or all JusCollege trips",
          ],
        },
        {
          ...
          highlights: [
            ...
            "Flexible activation fit across beach, nightlife, and hospitality moments",
            "Brand visibility can be packaged across any or all JusCollege trips",
          ],
        },
        {
          ...
          highlights: [
            ...
            "Strong fit for premium brand moments and hosted experiences",
            "Brand visibility can be packaged across any or all JusCollege trips",
          ],
        },
        {
          ...
          highlights: [
            ...
            "Strong fit for beverage, apparel, and travel activations",
            "Brand visibility can be packaged across any or all JusCollege trips",
          ],
        },
        {
          ...
          highlights: [
            ...
            "Flexible trip format for travel, hospitality, and experiential partners",
            "Brand visibility can be packaged across any or all JusCollege trips",
          ],
        },
      ],
